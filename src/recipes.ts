...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Place the chicken thighs skin-side down in the skillet and sear until golden brown, about 5-7 minutes. Flip and sear the other side for 2-3 minutes.",
      ...
      "Transfer the skillet to the preheated oven and bake for 35-45 minutes, or until the internal temperature of the chicken reaches 165°F.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Bake for 60-90 minutes. Check after 1 hour.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Bake until firm with small cracks on top, about 12–13 minutes.",
  ...
  },
  {
    ...
    steps: [
      ...
      "In a large bowl, whisk the granulated sugar and eggs until pale and foamy, about 1 minute.",
      ...
      "Pour the batter into the pan and bake until puffed and golden, and a skewer inserted into the center comes out clean, 25 to 35 minutes.",
