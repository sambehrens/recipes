...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      },
      {
        quantity: 4,
        measurement: "ounce",
        name: "diced green chiles (a small can is 4oz)",
        scaler: Scaler.Multiply,
      },
      {
        quantity: 0.5,
      ...
      },
      {
        quantity: 1,
        measurement: "count",
        name: "can of black beans, drained and rinsed (optional)",
        scaler: Scaler.Multiply,
      },
      {
        quantity: 8,
  ...
  },
  {
    ...
    steps: [
      ...
      "Bake for about 25-35 minutes, or until golden all around.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      },
      {
        quantity: 1,
        measurement: "noQuantity",
        name: "cinnamon sugar for rimming the glass",
        scaler: Scaler.Multiply,
      },
      {
        quantity: 1,
        measurement: "noQuantity",
        name: "orange slice, for garnish",
        scaler: Scaler.Multiply,
      },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      },
      {
        quantity: 2,
        measurement: "tablespoon",
        name: "small-diced pickles or cornichons",
        scaler: Scaler.Multiply,
      },
      {
        quantity: 1,
        measurement: "tablespoon",
        name: "Champagne or white wine vinegar",
        scaler: Scaler.Multiply,
      },
      {
        quantity: 1,
      ...
      },
      {
        quantity: 1,
        measurement: "noQuantity",
        name: "pinch of freshly ground black pepper",
        scaler: Scaler.Multiply,
      },
    ],
    steps: [
