...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    steps: [
      "Heat oil in a large nonstick skillet over medium-high. Add the beef and onion, season with salt and pepper, and cook, breaking into tiny pieces, until the beef starts to brown {Brown beef|5 minutes}.",
      "Stir in the tomato paste, then the cumin, paprika, ancho chile powder, and garlic powder. Cook, stirring occasionally, until fragrant and any excess liquid evaporates {Cook spices|3 minutes}. Transfer to a medium bowl and wipe out the skillet.",
      ...
      "Heat oil in the skillet over medium. Add the wrap seam-side down — placing the hot filling closest to the pan keeps the cold ingredients on top from warming. Cook until golden and crisp {Sear|2-3 minutes} per side. Repeat with remaining wraps, adding oil as needed.",
